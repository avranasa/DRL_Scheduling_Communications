...
N_samples_Stop_matrix = {'Gaussian':[500,1500,4000,10000],
            'Exp':[500,1500,4000,10000],
            'Gamma':[500,1500,4000,10000],
            'Mix_2_Gaussian':[500,1500,5000,10000],
            'Mix_3_Gaussian':[2000,5000,8000,15000]} 
...
for Name_distr, Gen in Gen_matrix.items():
    ...
    #Optimizers
    opt1 = optim.SGD([ParDistr], lr = LR, momentum=Momentum)
    opt2 = optim.SGD([ParCentDistrDuel_sep,ParMeanDuel_sep],lr = LR, momentum=Momentum)
...
pl.savefig('Appendix_fig2.eps', format='eps')
pl.show()